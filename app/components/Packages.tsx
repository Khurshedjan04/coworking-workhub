...
const Packages = () => {
  return (
    <div className="py-16 bg-[#010018] flex flex-col items-center justify-center text-white">
      <h1 className="text-4xl font-bold mb-8">Membership Packages</h1>
        ...
        {packages.map((item, index) => (
          ...
          >
            <div className="relative w-full h-full [transform-style:preserve-3d] transition-transform duration-500 group-hover:[transform:rotateY(180deg)] ">
              {/* front of the card */}
              <div className="absolute w-full h-full [backface-visibility:hidden] flex justify-center items-center bg-white text-cosumDarkBlue rounded-[1.25rem]">
